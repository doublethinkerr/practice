...
import ru.vlsu.practice.repository.TodoRepository;
import ru.vlsu.practice.service.dto.TodoDTO;
import ru.vlsu.practice.service.mapper.TodoMapper;
...
class TodoResourceIT {
    ...
    void createTodo() throws Exception {
        ...
        assertThat(testTodo.getDeleted()).isEqualTo(DEFAULT_DELETED);
        assertThat(testTodo.getDuration()).isEqualTo(DEFAULT_DURATION);
    }
    ...
    void putNewTodo() throws Exception {
        ...
        assertThat(testTodo.getDeleted()).isEqualTo(UPDATED_DELETED);
        assertThat(testTodo.getDuration()).isEqualTo(UPDATED_DURATION);
    }
